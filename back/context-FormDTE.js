    ...
    chrome.runtime.sendMessage({op: 'QuienSoy'}, null, function (response) {
        ...
        switch (window.location.href) {
            case 'https://www1.sii.cl/cgi-bin/Portal001/mipeGenFacEx.cgi?':
                ...
                break;
            case 'https://www1.sii.cl/cgi-bin/Portal001/mipeGenFacEx.cgi?PTDC_CODIGO=33', 'https://www1.sii.cl/cgi-bin/Portal001/mipeGenFacEx.cgi?PTDC_CODIGO=34',
                'https://www1.sii.cl/cgi-bin/Portal001/mipeGenFacEx.cgi?TIPO_PLANTILLA=NC_BLANCO&PTDC_CODIGO=61', 
                'https://www1.sii.cl/cgi-bin/Portal001/mipeGenFacEx.cgi?TIPO_PLANTILLA=NC_BLANCO&PTDC_CODIGO=56',
...
function RellenarFormularioSII(dte) {
    ...
    if (dte.items.some(function (item) {
        ...
        return true; })) //Verifica si algun item de la factura tiene impuesto
...
function clearDTE() {
    ...
    if ($("[name='OTRO_IMP_SI_NO']")[0].checked) $("[name='OTRO_IMP_SI_NO']")[0].checked;
    ...
    if ($("[name='COD_SI_NO']")[0].checked) $("[name='COD_SI_NO']")[0].click();


    if ($("[name='PAGO_SI_NO']").checked) {
